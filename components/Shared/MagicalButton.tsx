...
export default function MagicalButton({ disabled, onClick, children }: Props) {
  return (
    <div className="wrap">
      ...
      <style jsx>{`
        .wrap {
          /* tokens live here so all descendants inherit */
          --h: 64px;              /* big tap target */
          --r: 18px;
          --o1: #ff9f1a;          /* orange gradient */
          --o2: #ff7a00;
          --o3: #ff5607;
          --ring: rgba(255, 152, 0, 0.55);
        ...
        .glitter {
          ...
          background: #fff; box-shadow: 0 0 22px rgba(255, 255, 255, 0.95);
          pointer-events: none; animation: sparkle 1.6s ease-in-out infinite;
        }
        .g1 { left: 14px; top: 10px; animation-delay: 0s; }
        .g2 { right: 16px; bottom: 12px; animation-delay: 0.4s; }
        .g3 { left: -6px; bottom: 18px; animation-delay: 0.8s; }
